...
const List<String> kPaises = [
  "AFGANISTÁN", "ALAND", "ALBANIA", "ALEMANIA", "ANDORRA", "ANGOLA",
  "ANGUILA", "ANTÁRTICA", "ANTIGUA Y BARBUDA", "ARABIA SAUDITA", "ARGELIA",
  "ARGENTINA", "ARMENIA", "ARUBA", "AUSTRALIA", "AUSTRIA", "AZERBAIYÁN",
  "BAHAMAS", "BAHREIN", "BANGLADESH", "BARBADOS", "BÉLGICA", "BELICE",
  "BENIN", "BERMUDAS", "BIELORRUSIA", "BOLIVIA",
  "BONAIRE, SINT EUSTATIUS AND SABA", "BOSNIA-HERZEGOVINA", "BOTSWANA",
  "BRASIL", "BRUNEI", "BULGARIA", "BURKINA FASO", "BURUNDI", "BUTÁN",
  "CABO VERDE", "CAIMÁN, ISLAS", "CAMBOYA", "CAMERÚN", "CANADÁ",
  "CENTROAFRICANA, REPÚBLICA", "CHAD", "CHILE", "CHINA", "CHIPRE",
  "CIUDAD DEL VATICANO", "COLOMBIA", "COMORAS", "CONGO", "COSTA DE MARFIL",
  "COSTA RICA", "CROACIA", "CUBA", "CURAZAO", "DINAMARCA", "DOMINICA",
  "DJIBOUTÍ", "ECUADOR", "EGIPTO", "EL SALVADOR", "EMIRATOS ÁRABES UNIDOS",
  "ERITREA", "ESLOVAQUIA", "ESLOVENIA", "ESPAÑA", "ESTADOS UNIDOS",
  "ESTONIA", "ETIOPÍA", "FIJI", "FILIPPINAS", "FINLANDIA", "FRANCIA",
  "GABÓN", "GAMBIA", "GEORGIA", "GHANA", "GIBRALTAR", "GRANADA", "GRECIA",
  "GROENLANDIA", "GUADALUPE", "GUAM", "GUATEMALA", "GUAYANA FRANCESA",
  "GUERNSEY", "GUINEA", "GUINEA ECUATORIAL", "GUINEA-BISSAU", "GUYANA",
  "HAITÍ", "HONDURAS", "HONG KONG", "HUNGRÍA", "INDIA", "INDONESIA",
  "IRAK", "IRLANDA", "ISLA BOUVET", "ISLA DE MAN", "ISLA NORFOLK",
  "ISLANDIA", "ISLAS NAVIDAD", "ISLAS COCOS", "ISLAS COOK",
  "ISLAS FAROE", "ISLAS GEORGIAS D. S.-SANDWICH D. S.",
  "ISLAS HEARD Y MCDONALD", "ISLAS MALVINAS (FALKLAND)",
  "ISLAS MARIANAS DEL NORTE", "ISLAS MARSHALL", "ISLAS PITCAIRN",
  "ISLAS TURCAS Y CAICOS", "ISLAS ULTRAMARINAS DE E.E.U.U",
  "ISLAS VÍRGENES", "ISRAEL", "ITALIA", "JAMAICA", "JAPÓN", "JERSEY",
  "JORDANIA", "KAZAJISTÁN", "KENIA", "KIRGUISTÁN", "KIRIBATI", "KUWAIT",
  "LAOS, REPÚBLICA DEMOCRÁTICA", "LESOTHO", "LETONIA", "LÍBANO",
  "LIBERIA", "LIBIA", "LIECHTENSTEIN", "LITUANIA", "LUXEMBURGO", "MACAO",
  "MACEDONIA", "MADAGASCAR", "MALASIA", "MALAWI", "MALDIVAS", "MALÍ",
  "MALTA", "MARRUECOS", "MARTINICA E.A.", "MAURICIO", "MAURITANIA",
  "MAYOTTE", "MÉXICO", "MICRONESIA", "MOLDAVIA, REPÚBLICA DE", "MÓNACO",
  "MONGOLIA", "MONTENEGRO", "MONTSERRAT", "MOZAMBIQUE", "MYANMAR",
  "NAMIBIA", "NAURU", "NEPAL", "NICARAGUA", "NÍGER", "NIGERIA", "NIUE",
  "NORUEGA", "NUEVA CALEDONIA", "NUEVA ZELANDA", "OMÁN", "PAÍSES BAJOS",
  "PAKISTÁN", "PALAOS", "PALESTINA", "PANAMÁ", "PAPÚA, NUEVA GUINEA",
  "PARAGUAY", "PERÚ", "POLINESIA FRANCESA", "POLONIA", "PORTUGAL",
  "PUERTO RICO", "QATAR", "REINO UNIDO",
  "REP. DEMOCRÁTICA POPULAR DE COREA", "REPÚBLICA CHECA",
  "REPÚBLICA DE COREA", "REPÚBLICA DEMOCRÁTICA DEL CONGO",
  "REPÚBLICA DOMINICANA", "REPÚBLICA ISLÁMICA DE IRÁN", "REUNIÓN",
  "RUANDA", "RUMANIA", "RUSIA", "SAHARA OCCIDENTAL", "SAINT BARTHÉLEMY",
  "SAINT MARTIN (FRENCH PART)", "SALOMÓN, ISLAS", "SAMOA",
  "SAMOA AMERICANA", "SAN CRISTÓBAL Y NIEVES", "SAN MARINO",
  "SAN PEDRO Y MIQUELÓN", "SAN VICENTE Y LAS GRANADINAS", "SANTA ELENA",
  "SANTA LUCÍA", "SANTO TOMÉ Y PRÍNCIPE", "SENEGAL", "SERBIA",
  "SEYCHELLES", "SIERRA LEONA", "SINGAPUR", "SINT MAARTEN (DUTCH PART)",
  "SIRIA", "SOMALIA", "SOUTH SUDAN", "SRI LANKA", "SUDÁFRICA", "SUDÁN",
  "SUECIA", "SUIZA", "SURINÁM", "SVALBARD Y JAN MAYEN", "SWAZILANDIA",
  "TAILANDIA", "TAIWAN, PROVINCIA DE CHINA",
  "TANZANIA, REPÚBLICA UNIDA DE", "TAYIKISTÁN",
  "TERRITORIO BRITÁNICO OCÉANO INCICO", "TERRITORIOS AUSTRALES FRANCESES",
  "TIMOR ORIENTAL", "TOGO", "TOKELAU", "TONGA", "TRINIDAD Y TOBAGO",
  "TÚNEZ", "TURKMENISTÁN", "TURQUÍA", "TUVALU", "UCRANIA", "UGANDA",
  "URUGUAY", "UZBEKISTÁN", "VANUATU", "VENEZUELA", "VIETNAM",
  "ISLAS VÍRGENES BRITÁNICAS", "WALLIS Y FORTUNA, ISLAS", "YEMEN",
  "ZAMBIA", "ZIMBABUE"
];

const List<String> kActividades = [
  ...
  "91030 - Actividades de jardines botánicos, zoológicos y de reservas naturais", // 'naturais' parece un error tipográfico en el original, pero lo mantengo
  ...
  "94200 - Actividades de sindicatos", // Esta podría faltar en tu lista original
...
]; //'];' cierre la lista kActividades


// Mapa de Unidades de Medida (de 'options.html' <select>)
const Map<String, String> kUnidadesMedida = {
  "1": "Metro", "2": "Yarda", "6": "Milímetro", "9": "Kilómetro cuadrado",
  "10": "Hectárea", "13": "Metro cuadrado", "15": "Vara cuadrada",
  "18": "Metro cúbico", "20": "Barril", "22": "Galón", "23": "Litro",
  "24": "Botella", "26": "Mililitro", "30": "Tonelada", "32": "Quintal",
  "33": "Arroba", "34": "Kilogramo", "36": "Libra", "37": "Onza Troy",
  "38": "Onza", "39": "Gramo", "40": "Miligramo", "42": "Megawatt",
  "43": "Kilowatt", "44": "Watt", "45": "Megavoltio-amperio",
  "46": "Kilovoltio-amperio", "47": "Voltio-amperio", "49": "Gigawatt-hora",
  "50": "Megawatt-hora", "51": "Kilowatt-hora", "52": "Watt-hora",
  "53": "Kilovoltio", "54": "Voltio", "55": "Millar", "56": "Medio millar",
  "57": "Ciento", "58": "Docena", "59": "Unidad", "99": "Otra",
};
